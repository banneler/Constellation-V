...
const jarvisData = {
    ...
    'accounts.html': [
        ...
        { container: '.account-details-form-card', macro: 'Account Record. Edit fields, link to ZoomInfo and Salesforce, generate AI briefing, or draft meeting agenda.', nodes: [{ anchor: '#zoominfo-account-btn', text: 'Open account in ZoomInfo.' }, { anchor: '#salesforce-account-btn', text: 'Open account in Salesforce.' }, { anchor: '#ai-briefing-btn', text: 'Generate AI account briefing.' }, { anchor: '#draft-agenda-btn', text: 'Draft meeting agenda: build items and AI-generate copy for invites.' }, { anchor: '#sf-locator-edit-btn', text: 'Edit Salesforce ID.' }, { anchor: '#zoominfo-locator-edit-btn', text: 'Edit ZoomInfo company ID.' }, { anchor: 'form#account-form button[type="submit"]', text: 'Save account changes.' }, { anchor: '#delete-account-btn', text: 'Delete this account.' }, { anchor: '#account-is-customer', text: 'Toggle customer status.' }] },
        ...
        { container: '.account-proposals-card', macro: 'Proposals. Proposals linked to this account; open in builder or delete.', nodes: [{ anchor: '.account-proposals-list a[href^="proposals.html"]', text: 'Open this proposal in the proposal builder.' }, { anchor: '.proposal-delete-btn', text: 'Delete this proposal from the account.' }] },
    ...
    'irr.html': [
        { container: '.section-card:has(#global-results-container)', macro: 'Strategic Capital Allocation Engine. Modeling multi-site internal rates of return, NPV, payback, and promotional free-month impact.', nodes: [{ anchor: '#new-project-btn', text: 'Start new project (resets current).' }, { anchor: '#load-project-btn', text: 'Load saved project.' }, { anchor: '#save-project-btn', text: 'Persist project to secure database.' }, { anchor: '#add-site-btn', text: 'Add site to project.' }, { anchor: '#print-report-btn', text: 'Print report.' }, { anchor: '#export-csv-btn', text: 'Export to CSV.' }, { anchor: '#global-discount-rate', text: 'Set the NPV discount rate.' }, { anchor: '#global-free-months-toggle', text: 'Apply free-month promo settings to all sites.' }, { anchor: '#tab-scroll-left', text: 'Scroll site tabs left.' }, { anchor: '#tab-scroll-right', text: 'Scroll site tabs right.' }, { anchor: '.delete-site-btn', text: 'Remove this site from project.' }] },
    ...
    'insights.html': [
        { container: '#insights-content', macro: 'Manager Insights. Team utilization, funnel, sequences, campaigns, Cognito follow-through, and SAOS coverage.', nodes: [{ anchor: '#insights-rep-filter', text: 'Filter by rep.' }, { anchor: '#insights-date-filter', text: 'Filter by date range.' }, { anchor: '#insights-view-combined-btn', text: 'Combined chart view — leadership brief export.' }, { anchor: '#insights-view-individual-btn', text: 'Individual chart view — coaching guide export.' }, { anchor: '#insights-export-btn', text: 'Export leadership brief or coaching guideline.' }, { anchor: '#insights-refresh-btn', text: 'Refresh Insights data.' }] }
    ],
    'admin.html': [
