        ...
        <div>
            <div class="guide-card">
                ...
                <ul>
                    ...
                    <li><strong>Advanced Sorting & Filtering (Accounts):</strong> On the Accounts page, use the dropdown menus to sort your list by Name, Last Activity, or Creation Date.</li>
            ...
            <div class="guide-card">
                ...
                <p>Our import tool does more than just add new records; it intelligently detects and handles potential duplicates or updates to existing records.</p>
                <ol>
                    <li>On the Contacts or Accounts page, click "More Actions" and select "Bulk Import from CSV".</li>
                    <li>After uploading your file, the system will present you with a preview.</li>
                    <li><strong>Review Changes:</strong> For each row, the system will indicate if it's a "New Record", a "Potential Duplicate", or an "Update to Existing".</li>
                    <li><strong>Accept or Reject:</strong> You have row-by-row control. Use the checkboxes to accept the suggested changes or skip a specific row if you don't want to import it.</li>
                    <li>Click "Confirm Import" to finalize the process. This gives you complete control over your data integrity.</li>
                </ol>
            </div>
            <div class="guide-card">
                <h3>How-To: AI Features</h3>
        ...
        <div>
            <div class="guide-card">
                ...
                <ul>
                    ...
                    <li><strong>Deals Table:</strong> A comprehensive, sortable list of all your deals in the active pipeline.</li>
                    <li><strong>Recently Closed View:</strong> Toggle to this view to see a list of your "Closed Won" deals, perfect for celebrating wins and reviewing past successes.</li>
    ...
    "cognito-social": `
        <div>
            <div class="guide-card">
                ...
                <p>When new intelligence alerts (Cognito) or social content (Social Hub) have been added since your last visit, a bell icon will appear next to the corresponding link in the main navigation sidebar, ensuring you never miss a timely update.</p>
