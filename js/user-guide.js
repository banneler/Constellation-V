...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Store the HTML content for each "page" of the user guide, now with proper wrappers
    const guideContent = {
        introduction: `
    ...
    function renderContent(pageId) {
        mainContent.innerHTML = guideContent[pageId] || `<div class="container mx-auto px-6 py-8"><p>Content not found.</p></div>`;
