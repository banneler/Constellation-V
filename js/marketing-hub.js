...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    const renderContent = () => {
        ...
        if (createNewItemBtn) createNewItemBtn.classList.remove('hidden');
        ...
        if (state.currentView === 'email-templates') {
            ...
            // Hide the left panel controls when in social post view
            if (createNewItemBtn) createNewItemBtn.classList.add('hidden');
        }
    };
